    ...
    <div id="main-wrapper">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="resources/assets/images/users/1.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid" src="resources/assets/images/big/img1.jpg" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="resources/assets/images/big/img2.jpg" alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="resources/assets/images/big/img3.jpg" alt="Third slide"></div>
                                                </div>
                                            </div>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
             ...
             <div class="accordion ">Applicant Tertiary Education</div>                   
                 <div class="col-lg-24">   
   ...
   <div >
                            <div class="card-body">
                                ...
                                <div class="table-responsive ">
                                    <form action="${pageContext.request.contextPath}/updateEdu">
                                    ...
                                    <tbody>
                                            ...
                                            <c:forEach  var="lines" items= '<%= request.getAttribute("tertiaryEducation") %>'>
                                            <tr> 
                                         
     
                                           <td><input type="text" class="form-control"  name="Name" value="${lines.getNUSTUSDApplicantEducationPK().getName()}"/>
                                           <input type="hidden" class="form-control"  name="appNo" value="${lines.getNUSTUSDApplicantEducationPK().getApplicantNo()}" readonly/></td>

                                             <td><input type="text"  name="startyear" class="form-control" value="${lines.getStartYear()}"/></td>
                                             <td><input type="text"  name="endyear" class="form-control" value="${lines.getEndYear()}"/></td>
                                             <td><input type="text" name="programmeofstudy" class="form-control" value="${lines.getProgrammeofStudy()}"/></td>

                                             <td><input type="text" name="overall" class="form-control" value="${lines.getOverallClassification()}"/></td>
                                             
                                   <td><input type="text" name="subgrades" class="form-control"  value="${lines.getSubjectsandGrades()}"/></td>

                           
                                            
                                             <td><input type="text" class="form-control"    class="form-control" value="${lines.getDateofAward()}" readonly/></td>
                                              <td><input type="date" class="form-control"   name="dateofaward"  value="${lines.getDateofAward()}"/></td>
