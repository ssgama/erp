                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive ">
                                    ...
                                    <tbody>
                                            ...
                                            <c:forEach  var="lines" items= '<%= request.getAttribute("employment") %>'>
                                            <tr>    
                                            <td><c:out value="${lines.getNUSTUSDApplicantEmploymentPK().getStartDate()}"/></td>
                                            
                                             
                                             <td><c:out value="${lines.getEndDate()}"/></td>
                                             <td><c:out value="${lines.getOccupationDetails()}"/></td> 
                                             <td><c:out value="${lines.getEmployer()}"/></td>
                                             <td><c:out value="${lines.getRemarks()}"/></td> 
