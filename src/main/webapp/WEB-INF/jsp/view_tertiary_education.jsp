                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive ">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Overall Classification</th>
                                             ...
                                             <th>Subject and Grades 2</th>
                                             <th>Overall Classification</th>
                                             <th>Date of Award</th>
                                             <th>Start Year</th>
                                             <th>End Year</th>
                                             <th>Enough Data</th>
                                             <th>Qualification Completed</th>
                                             <th>Time Stamp</th>
                                             <th>Hash Code</th>
                                    ...
                                    <tbody>
                                            ...
                                            <tr>    
                                            <td><c:out value="${lines.getProgrammeofStudy()}"/></td>
                                            
                                             
                                             <td><c:out value="${lines.getOverallClassification()}"/></td>
                                             <td><c:out value="${lines.getSubjectsandGrades()}"/></td>
                                             <td><c:out value="${lines.getSubjectsandGrades2()}"/></td>
                                             <td><c:out value="${lines.getOverallClassification()}"/></td>
                                             <td><c:out value="${lines.getDateofAward()}"/></td>
                                             <td><c:out value="${lines.getStartYear()}"/></td>
                                             <td><c:out value="${lines.getEnoughData()}"/></td>
                                              <td><c:out value="${lines.getQualificationCompleted()}"/></td>
                                             <td><c:out value="${lines.getTimestamp()}"/></td>
                                             <td><c:out value="${lines.gethashCode()}"/></td>
