...
<%@page import="nust.systems.workingcrud.entities.NUSTUSDApplicantReferee" %>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
             ...
             <div class="accordion ">Referees</div>                   
                 <div class="col-lg-12">   
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive ">
                                    ...
                                    <tbody>
                                            ...
                                            <c:forEach  var="lines" items= '<%= request.getAttribute("referee") %>'>
                                            <tr>    
                                            <td><c:out value="${lines.getReferree()}"/></td>
                                            
                                             
                                             <td><c:out value="${lines.getRefereeAddress()}"/></td>
                                             <td><c:out value="${lines.getRefereeAddress2()}"/></td> 
