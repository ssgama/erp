...
<head>
    ...
    <title>NUST MANAGEMENT SYSTEM :: Undergraduate Application Form</title>
    <!-- Bootstrap Core CSS -->
...
<SCRIPT language="javascript">
    ...
    <!--Function to close accordion on submit-->
<script>
  $(document).foundation(); 
  var foo = new Foundation.Accordion($("#foo"));
  $("#btnDown").on("click", function() {
    if (!$("#panel1").parent().hasClass("is-active")) {
      foo.down($("#panel1"));
      // this works too
      //  $("#foo").foundation("down",$("#panel1"));
    }
  });
  $("#btnUp").on("click", function() {
    if ($("#panel1").parent().hasClass("is-active")) {
      foo.up($("#panel1"));
      // this works too
      //  $("#foo").foundation("up",$("#panel1"));
    }
  });
  // event binding
  $("#foo")
  .on("down.zf.accordion", function(ev,$panel) {
      console.log("Panel "+ev.target.id+" / "+$panel.attr('id')+" is down, do something");
  })
  .on("up.zf.accordion", function(ev,$panel) {
      console.log("Panel "+ev.target.id+" / "+$panel.attr('id')+" is up, do something");
  });
...
%>
                                            <a href="${pageContext.request.contextPath}/findUnder1" class="btn btn-info"><img src="resources/assets/images/c41.png">New</a>
...
<!--        <aside class="left-sidebar">
        ...
        <!-- ============================================================== -->
                 ...
                 <div class="col-lg-12"  class="collapse show">   
                        ...
                        <div class="card col-lg-12" style="float: left" class="collapse show" role="tabpanel" aria-expanded="true">
                            <div class="card-body">
                                <div class="table-responsive ">
                                    <table class="table table-striped" style="border: 1px solid #dee2e6">
                                        
    <tbody>
                                                   <form name="search_input"  action="${pageContext.request.contextPath}/addUnderDetails">
...
<option value="" disabled selected>Click To Select Citizenship</option>
	...
	<option value="ZW" ${citizenship == 'ZW' ? 'selected' : ''}>Zimbabwean</option>
										...
										<p id="error-step12"></p>
											...
											<input name="Specify" type="text" class="form-control" id="contact-name" required="required" placeholder="If Any Disabilities. Please Specify"/>
								...
								<div class="widget-content">
													...
													<div class="form-group">
														...
														<input name="Address1" type="tel" id="contant-name" maxlength="30" class="form-control" placeholder="House Number&Street"  required="required" required data-parsley-errors-container="#error-step5" />
													</div>
													<div class="form-group">
														<label for="contact-address2">SUBURB *</label>
														<input name="Address2" type="text" id="contact-name" maxlength="30" class="form-control" placeholder="Surbub"  required="required" required data-parsley-errors-container="#error-step5" />
													</div>
													<div class="form-group">
														<label for="contact-city">CITY *</label>
														<input name="City" type="text" id="contact-name" maxlength="30" class="form-control" placeholder="City"  required="required" required data-parsley-errors-container="#error-step5"/>
													</div>
...
<option value="" enabled selected>Click To Select End Year</option>
	...
	<option value="2000" ${endyear == '2000' ? 'selected' : ''}>2000</option>
        ...
        <tr >
                    <td > 
                        <input class="btn btn-secondary dropdown-toggle"  type="submit" id="my_centered_buttons" >
                          </center>
                    </td>
                </tr>
            </table>
    ...
    <tbody>
                     ...
                     <button class="accordion ">Applicant Qualification ::..  <c:out value="${appNo}" /></button>
                        ...
                        <div class="card col-lg-12" style="float: left">
                            <div class="card-body">
                                <div class="table-responsive ">
                                    ...
                                    <form name="search_input"  action="${pageContext.request.contextPath}/addUnderQua">
...
<td>
 ...
 <tr>
                    ...
                    <td><input class="btn btn-secondary dropdown-toggle" type="submit" id="dropdownMenuButton"></td>
                                ...
                                <button class="accordion ">Applicant Choice ::..  <c:out value="${appNo}"/> </button>
                 <div class="col-lg-12" style="display: none">   
         ...
         <form name="search_input"  action="${pageContext.request.contextPath}/addUnderChoice">
                                    <div class="dropdown pull-right m-r-10 hidden-sm-down">
                                    </div>
                                    <div class="row">
                                     <div class="col-md-4">  
								...
								<div class="widget-content">
									...
									<div class="form-group has-success">
										<label class="control-label">First Choice (Conventional Programmes) </label>
...
<option value="ILIP" ${parrallel[5][1] == 'ILIP' ? 'selected' : ''}>Bachelor of Science Honours Degree in Library and Information Science</option>
							...
							<div class="widget">
								<div class="widget-header">
									<h3><i class="fa fa-edit"></i>BLOCK PROGRAMMES CHOICES </h3></div>
								<div class="widget-content">
