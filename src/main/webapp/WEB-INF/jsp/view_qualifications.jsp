...
<!--                                <img src="resources/assets/images/logo-text.png" alt="homepage" class="dark-logo" />
        ...
        <div>
            ...
            <div class="container-fluid">
             ...
             <div class="accordion ">Qualifications</div>                   
                 <div class="col-lg-12">   
                                ...
                                <div class="table-responsive ">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <tr>    
                                            <td><c:out value="${lines.getProgrammeDescription()}"/></td>
                                            
                                             
                                             <td><c:out value="${lines.getExaminationBody()}"/></td>
                                             <td><c:out value="${lines.getLevel()}"/></td> 
                                             <td><c:out value="${lines.getExamDate()}"/></td> 
                                             <td><c:out value="${lines.getClassification()}"/></td>
                                             <td><c:out value="${lines.getSubjectPoints()}"/></td>                                               
                                              
                                              <td><c:out value="${lines.getSubject()}"/></td> 
                                              
                                              <td><c:out value="${lines.getCandidateNo()}"/></td> 
                                              <td>
                                                
                                                  <!-- Start of choices -->
                                                <c:set var="status" scope="session" value="${lines.getMismatch()}"/>
