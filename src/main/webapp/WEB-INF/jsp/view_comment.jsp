...
<%@page import="nust.systems.workingcrud.entities.NUSTUSDCommentLine" %>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
             ...
             <div class="accordion ">Comment Sheet</div>                   
                 <div class="col-lg-12">   
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive ">
                                    ...
                                    <tbody>
                                            ...
                                            <c:forEach  var="lines" items= '<%= request.getAttribute("comments") %>'>
                                            <tr>    
                                            
                                            
                                             
                                             <td><c:out value="${lines.getDate()}"/></td>
                                             <td><c:out value="${lines.getComment()}"/></td> 
