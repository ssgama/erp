                ...
                <div class="container-fluid"> 
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><c:out value="${count}" /> Unselected Applicants</h4>
                                    <h6 class="card-subtitle">
                                        <a href="${pageContext.request.contextPath}/all" class="btn btn-info"><i class="fa fa-check"></i> All Applicants</a>
