...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
 <% 
List<NUSTUSDApplicant> resultList = new ArrayList<>();
resultList=(List<NUSTUSDApplicant>)request.getAttribute("getSelectedApplicants");
request.setAttribute("selected_appl", resultList);
%>
...
<div class="dropdown pull-right m-r-10 hidden-sm-down"> 
                                <form name="search_input"  action="${pageContext.request.contextPath}/findByProg">
                                    <div class="dropdown pull-right m-r-10 hidden-sm-down">
                                        <input class="btn btn-secondary dropdown-toggle" type="submit" id="dropdownMenuButton"> 
                                    </div>
                                    <input type="text" placeholder="Selected Program" style="padding-left: 25px;"  name="prog_name">
                                </form>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><c:out value="${count}" /> Selected Applicants</h4>
                                    <h6 class="card-subtitle">
                                        <a class="btn btn-info" href="${pageContext.request.contextPath}/all" ><i class="fa fa-check"></i> All Applicants</a>
                                        <a class="btn btn-info" href="${pageContext.request.contextPath}/unselected"><i class="fa fa-undo"></i> Unselected Applicants</a>
                                    </h6>
                                            ...
                                            <thead>
                                             ...
                                             <tbody>
                                                 <tr>
                                                   ...
                                                   <c:forEach  var="applicant" items="${getSelectedApplicants}"  >
