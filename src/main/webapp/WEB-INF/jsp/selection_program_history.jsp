...
<% System.out.println("now in view selection history"); %>
...
<!--                                <img src="resources/assets/images/logo-text.png" alt="homepage" class="dark-logo" />
        ...
        <div>
            ...
            <div class="container-fluid">
             ...
             <div class="accordion ">Selection History</div>                   
                 <div class="col-lg-12">   
                                ...
                                <div class="table-responsive ">
                                    ...
                                    <thead>
                                        <tr>
                                         ...
                                         <c:forEach  var="lines" items= '<%= request.getAttribute("ProgHistory") %>'>
                                            <tr>    
                                                 ...
                                                 <td><c:out value="${lines.getNUSTUSDApplicantSelectionAidJournPK().getNo()}"/></td>
                                                   
                                             
                                      
                                             <td><c:out value="${lines.getChoiceNumber()}"/></td>
                                             <td><c:out value="${lines.getRankingNo()}"/></td>                                               
                                              
                                              <td><c:out value="${lines.getNUSTUSDApplicantSelectionAidJournPK().getProgramme()}"/></td> 
                                               <td><c:out value="XXXXXXXXXXXXXXXXXX"/></td>
                                               <td><c:out value="XXXXXXXXXXXXXXXXXXXX"/></td> 
